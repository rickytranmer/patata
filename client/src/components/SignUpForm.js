		...
		return (
			<div className="SignUpForm">
				<form className="task-form" onSubmit={(event)=> this.onFormSubmit(event)}>
					...
					<input disabled type="password" id="password-input-1" name="password1" maxLength="50" required />

					<label htmlFor="password2">-Retype Password-</label>
					<input disabled type="password" id="password-input-2" name="password2" maxLength="50" required />
